...
- normalize_spike_times: Converts various input formats to canonical list-of-arrays
...
# ==============================================================================
# Test normalize_spike_times: 1D array input (single neuron)
# ==============================================================================
...
class TestNormalizeSpikeTimesSingleNeuron:
    ...
    def test_1d_array_returns_list_of_length_1(
        ...
        result = normalize_spike_times(single_neuron_spikes)
    ...
    def test_empty_1d_array(self) -> None:
        ...
        result = normalize_spike_times(empty)
        assert len(result) == 1
    ...
    def test_single_spike(self) -> None:
        ...
        single = np.array([1.5])
        result = normalize_spike_times(single)
        assert len(result) == 1
    ...
    def test_1d_integer_array_converted_to_float(self) -> None:
        ...
        result = normalize_spike_times(int_spikes)
        assert result[0].dtype == np.float64
        np.testing.assert_array_equal(result[0], [1.0, 2.0, 3.0])


# ==============================================================================
# Test normalize_spike_times: 2D array input (NaN-padded)
# ==============================================================================
...
class TestNormalizeSpikeTimesNaNPadded:
    ...
    def test_2d_array_returns_list_of_correct_length(
        ...
        result = normalize_spike_times(multi_neuron_2d)
        assert isinstance(result, list)
        assert len(result) == 3
    ...
    def test_2d_array_all_nan_row(self) -> None:
        ...
        result = normalize_spike_times(arr)
        assert len(result) == 3
...
# ==============================================================================
# Test normalize_spike_times: list/tuple of arrays (canonical format)
# ==============================================================================
...
class TestNormalizeSpikeTimesListInput:
    ...
    def test_list_of_arrays_passthrough(
        ...
        result = normalize_spike_times(multi_neuron_list)
        assert isinstance(result, list)
...
# ==============================================================================
# Test normalize_spike_times: Error handling
# ==============================================================================
...
# ==============================================================================
# Test normalize_spike_times: Edge cases
# ==============================================================================
...
class TestSpikesImports:
    ...
    def test_normalize_spike_times_importable(self) -> None:
        """normalize_spike_times should be importable from encoding._spikes."""
        from neurospatial.encoding._spikes import normalize_spike_times

        assert callable(normalize_spike_times)
