...
from neurospatial.encoding.place import _binned_rate_map, compute_place_field


class TestBinnedRateMap:
    """Test suite for _binned_rate_map function."""

    def test_binned_rate_map_synthetic(self):
        """Test that _binned_rate_map with known spike rate produces expected field."""
        ...
        field = _binned_rate_map(env, spike_times, times, positions)
    ...
    def test_binned_rate_map_min_occupancy(self):
    ...
    def test_binned_rate_map_empty_spikes(
    ...
    def test_binned_rate_map_out_of_bounds_time(
        self, spike_field_env_100: Environment, spike_field_trajectory
    ):
    ...
    def test_binned_rate_map_out_of_bounds_space(
        self, spike_field_env_100: Environment, spike_field_trajectory
    ):
    ...
    def test_binned_rate_map_1d_trajectory(self):
    ...
    def test_binned_rate_map_1d_no_column_dimension(self):
    ...
    def test_binned_rate_map_nan_occupancy(
        self, spike_field_env_100: Environment, spike_field_trajectory
    ):
    ...
    def test_binned_rate_map_known_firing_rate(self):
    ...
    def test_binned_rate_map_parameter_order(self):
    ...
    def test_binned_rate_map_validation(self):
        ...
        with pytest.raises(
            ...
            _binned_rate_map(env, spike_times, bad_times, positions)
