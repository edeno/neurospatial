...
> **Status:** v0.6 is currently unreleased. This guide describes the upcoming
> v0.6 API on the release branch; the latest published package/docs may still
> report v0.5.x until the final release step.
