...
- [x] Move functions from `reward.py` → `behavior/reward.py`
...
- [x] Update imports for `reward` → `behavior.reward`
...
- [x] Move functions from `object_vector_field.py` → `encoding/object_vector.py`
- [x] Move functions from `metrics/object_vector_cells.py` → `encoding/object_vector.py`

#### 6.6: Create encoding/spatial_view.py

- [x] Move functions from `spatial_view_field.py` → `encoding/spatial_view.py`
- [x] Move functions from `metrics/spatial_view_cells.py` → `encoding/spatial_view.py`
- [x] Add re-exports from `ops.visibility`: `compute_viewed_location`, `compute_viewshed`, `visibility_occupancy`, `FieldOfView`
...
- [x] Move functions from `metrics/population.py` → `encoding/population.py`
