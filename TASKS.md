...
- [ ] **1.1** Create `src/neurospatial/annotation/__init__.py` with public exports
...
- [ ] **2.1** Create `src/neurospatial/annotation/converters.py`
...
- [ ] **6.1** Create `tests/annotation/__init__.py`
- [ ] **6.2** Create `tests/annotation/test_converters.py`
